...
const AdminAnalytics = () => {
  ...
  const handleRunAnalysis = useCallback(async () => {
    ...
    try {
      ...
      if (targetStudent) {
        ...
        const worker = new Worker(new URL('../lib/saie-worker.ts', import.meta.url), { type: 'module' });
  ...
  }, [allBehaviorLogs, students, targetStudent, allActiveStudents, behaviorLogs, setTargetStudent, setForecast, setForecastAlert, setAiAssistant, setAiHistory, setAnalysisComplete, setIsAnalyzing, setShowHistory]);
