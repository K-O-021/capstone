...
const ParentProgress = () => {
  ...
  const studentData = {
    name: "GARCIA, HEART KRISTALIN M.",
    condition: "Cerebral Palsy",
    specialization: "Transition Elementary",
    growthIndex: "+24.5%",
    aiConfidence: "98.2%",
    lastUpdate: "April 27, 2026",
    competency: [
      { subject: 'Communication', baseline: 15, current: 48, fullMark: 100 },
      { subject: 'Motor Skills', baseline: 10, current: 35, fullMark: 100 },
      { subject: 'Social Skills', baseline: 25, current: 62, fullMark: 100 },
      { subject: 'Stability', baseline: 30, current: 78, fullMark: 100 },
      { subject: 'Focus', baseline: 20, current: 50, fullMark: 100 },
    ],
    weeklyTrend: [
      { day: 'Mon', level: 65 }, { day: 'Tue', level: 75 }, 
      { day: 'Wed', level: 45 }, { day: 'Thu', level: 85 }, 
      { day: 'Fri', level: 90 }
    ],
    logs: [
      { id: 101, date: "Apr 24", category: "Motor Skills", note: "Heart successfully attempted tracing vertical lines today.", status: "Verified" },
      { id: 102, date: "Apr 23", category: "Social", note: "Highly engaged with classmates during sensory play.", status: "Verified" },
    ]
  };
